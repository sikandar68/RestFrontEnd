...
export default {
  ...
  customerPhoneRequired : "مطلوب هاتف العميل",
  customerNameRequired : "اسم العميل مطلوب",
  homeNumber : "رقم البيت",
  ...
  collection: "مجموعة",
  address: "عنوان",
  orderDetails: "تفاصیل الطلب",
  percentage: "نسبة مئوية",
  newItem : "عنصر جديد",
  addSplitter: "إضافة الفاصل",
  removeSplitter: "إزالة الفاصل",
  splitter: "الفاصل",
  updateOrderPending : "يُحذًِر! تحديث الطلب معلق",
};
